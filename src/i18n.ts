  ...
  th: {
    translation: {
      ...
      admin: {
        ...
        product_tags: "สินค้าที่เกี่ยวข้อง",
        settings: "ตั้งค่า",
        analytics: "สถิติการใช้งาน",
        traffic_analytics: "สถิติการใช้งาน",
        traffic_desc: "ข้อมูลแสดงการใช้งาน",
        total_page_views: "จำนวนเข้าชม (ครั้ง)",
        unique_visitors: "ผู้เข้าชม (คน)",
        avg_session: "ระยะเวลาเข้าชมเฉลี่ย",
        bounce_rate: "อัตราตีกลับ",
        traffic_overview: "ภาพรวมการเข้าชม",
        sessions_device: "การเข้าชมตามอุปกรณ์",
        top_pages: "หน้าที่เข้าชมสูงสุด",
        page_path: "หน้าเว็บ",
        time_on_page: "ระยะเวลาบนหน้าเว็บ",
        vs_previous: "เทียบกับช่วงก่อนหน้า",
        financial: "รายได้",
        packages: "แพ็กเกจ",
        ...
        relationships: "บทความที่เกี่ยวข้อง",
    ...
    translation: {
      ...
      services_section: {
        ...
        items: [
          ...
          {
            title: "Social Media Marketing",
            desc: "Drive sales and brand awareness through social media",
            highlight: "Generate sales with content that reaches your customers",
            features: [
              "Manage Facebook, Instagram, TikTok pages",
              "Plan Content Strategy",
              "Design eye-catching graphics and images",
              "Social Media Advertising (Facebook Ads, TikTok Ads)",
              "Analyze backend data and competitors",
              "Organize campaigns and promotions",
              "Build customer relationships (Community Management)"
            ]
          }
        ]
      },
      ...
      admin: {
        ...
        product_tags: "Related Products",
        settings: "Settings",
        analytics: "Analytics",
        traffic_analytics: "Traffic Analytics",
        traffic_desc: "Usage statistics and overview",
